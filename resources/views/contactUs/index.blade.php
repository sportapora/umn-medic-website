    ...
    <div class="flex custom-container">
        <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col ms-2 mt-2">
                ...
                <p class="">2. Anggota Medic wajib mendapatkan konsumsi yang layak apabila pengaju membutuhkan jasa
                    medis selama 3 jam atau lebih. Jumlah konsumsi disesuai kan dengan jumlah tenaga medis yang
                    diajukan.</p>
                <p class="">3. Pengaju wajib datang ke UKK apabila sudah dihubungi oleh pihak UMN Medical Center, untuk
                    menandatangani form pengajuan.</p>
                <p class="">4. Anggota Medic wajib diperlakukan dengan baik sesuai aturan serta norma yang berlaku. Jika
                    ditemukan perlakukan tidak baik terhadap anggota Medic, maka Medic berhak memberikan sanksi yang
                    terberat adalah dengan menarik anggota dari pengajuan jasa dan blackpst acara.</p>
                <br/>
            ...
            <div class="flex justify-center mt-24">
                <a type="button" href="{{route('form.create')}}"
