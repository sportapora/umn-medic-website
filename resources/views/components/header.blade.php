            ...
            >
                ...
                >
                    ...
                    <span class="h-12 w-12 rounded-full">
                        <img src="{{asset(auth()->user()->photo ?? 'assets/user/user-01.png')}}" alt="User"/>
                    </span>
                </a>
                ...
                >
                    ...
                    >
                        <li>
                            <a
                                ...
                                class="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-medic-primary lg:text-base"
                            >
                                <svg
                                    class="fill-current"
                                    width="22"
                    ...
                    <a
                        ...
                        class="flex items-center gap-3.5 px-6 py-4 text-sm font-medium duration-300 ease-in-out hover:text-medic-primary lg:text-base"
                    >
                        <svg
                            class="fill-current"
                            width="22"
